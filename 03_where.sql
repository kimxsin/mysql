...
-- tbl_메뉴 테이블에서 이름, 가격, 판매상태를 조회할거야
-- 근데 메뉴 가격이 130000원 인 메뉴만 조회해줘
...
from
	tbl_menu
where
	menu_price >= '10000' and munu_price < '20000';

-- and / or 연산자
-- where 절과 함께 사용하며 자바와 똑같다
	...
	*
    from
     ...
     where
       ...
       order by category_code; -- 쓰지않으면 asc 기본값
...
-- category_code = 4 or category_code = 5 category_code = 6 축약하는 코드
